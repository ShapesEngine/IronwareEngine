	...
	slot( slot )
{
	...
	GFX_THROW_INFO( GetDevice( gfx )->CreateBuffer( &descConstBuffer, nullptr, &pConstantBuffer ) );
}
	...
	slot( slot )
{
	...
	GFX_THROW_INFO( GetDevice( gfx )->CreateBuffer( &descConstBuffer, &subresConstData, &pConstantBuffer ) );
}
